public interface SparseInterface {
    ...
    Sets maximum size of the matrix. Number of rows. It should also clear matrix (make all elements 0)
    ...
    public SparseInterface removeElement(int row, int col);
    ...
    /*
    Should return the nonzero elements of your sparse matrix as a string. The string should be k lines, where k
    is the number of nonzero elements.

    Each line should be in the format "row column data" where row and column are the "coordinate" of the data
    and all are separated by spaces. The empty matrix should return an empty string. The print should be from
    left to right and fro top to bottom (like reading a book) i.e. matrix
                                                3 0 1
                                                0 2 0
                                                0 0 4
